...
class HomeController : SceneController
{
    ...
    void Start()
    {
        ...
        thirdDialogTrigger.OnDie += () => { BossHP.gameObject.SetActive(false); DisableControl(); dialog.StartDialog("Home2"); gate.canTrigger = true; };
        transition.OnFadeOutDone += (e) => { dialog.StartDialog("Home"); };
